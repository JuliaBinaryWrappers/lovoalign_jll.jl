# `lovoalign_jll.jl` (v20.0.2+0)

[![deps](https://juliahub.com/docs/lovoalign_jll/deps.svg)](https://juliahub.com/ui/Packages/lovoalign_jll/96MCi?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/bb8bd32f22467fc1eaaf8fcf28744ed0fe397e72/L/lovoalign/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `lovoalign_jll.jl` have been built from these sources:

* git repository: https://github.com/m3g/lovoalign.git (revision: `cba28738a5a945475570f5869b2efe9c0c2573eb`)

## Platforms

`lovoalign_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `lovoalign_jll.jl`:
